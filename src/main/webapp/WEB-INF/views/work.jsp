...
<body>
	<div id="helpBox">
		<div id="active6">
			<input id="text" type="text" maxlength="50" placeholder="제목을 입력해주세요.">
			<img id="help" type="image" src="resources/work/help.PNG" style="cursor:pointer">
		</div>
	</div>
	<div class="contain">
		<div class="side">
