...
<script>
   $(document).ready(function(){
      ...
      var tr8 = "<span class='close'>&times;</span>" + "<p>"
            ...
            + "<button type='button' id='findid3'>ID찾기</button>"
            + "<button type='button' id='settingpw2'>비밀번호 재설정</button>";
      ...
      function btnFindid3() {//id찾기
         $("#findid3").on("click", function() {
            $(".modal-content2").html(tr);
            btnFindid2();
            btnSpan();
         });
      }
      ...
      function btnSettingpw2() {//비밀번호 재설정
         $("#settingpw2").off().on("click", function() {
            //             alert("메롱");
            $(".modal-content2").html(tr4);
